 ...
 */
public class CreditFourthFragment extends Fragment {
    ...
    // 과목순서 - 체크박스 매핑
    HashMap<Integer, CheckBox> defaultChk2017_4;
    HashMap<Integer, CheckBox> defaultChk2016_4;
    HashMap<Integer, CheckBox> defaultChk2015_4;
    HashMap<Integer, CheckBox> defaultChk2014_4;
    HashMap<Integer, CheckBox> defaultChk2013_4;

    public CreditFourthFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_credit_fourth, container, false);
        ...
        button2017.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    int sum=0;
                    OutputStreamWriter out = new OutputStreamWriter(getActivity().openFileOutput(file2017_4, 0));
                    ...
                    out.close();
                    //2017_4 이수학점 총합 저장
                    sharedPreferencesCreditSum("sum2017_4", sum);
                    sharedPreferences();
        ...
        button2016.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    int sum=0;
                    OutputStreamWriter out = new OutputStreamWriter(getActivity().openFileOutput(file2016_4, 0));
                    ...
                    out.close();
                    //2016_4 이수학점 총합 저장
                    sharedPreferencesCreditSum("sum2016_4", sum);
                    sharedPreferences();
                    //다른 학번 파일 전부 0으로 reset
                    reset2017Credit();
                    reset2015Credit();
        ...
        button2015.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    int sum=0;
                    OutputStreamWriter out = new OutputStreamWriter(getActivity().openFileOutput(file2015_4, 0));
                    ...
                    out.close();
                    //2015_4 이수학점 총합 저장
                    sharedPreferencesCreditSum("sum2015_4", sum);
                    sharedPreferences();
                    //다른 학번 파일 전부 0으로 reset
                    reset2017Credit();
                    reset2016Credit();
        ...
        button2014.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    int sum=0;
                    OutputStreamWriter out = new OutputStreamWriter(getActivity().openFileOutput(file2014_4, 0));
                    ...
                    out.close();
                    //2014_4 이수학점 총합 저장
                    sharedPreferencesCreditSum("sum2014_4", sum);
                    sharedPreferences();
                    //다른 학번 파일 전부 0으로 reset
                    reset2017Credit();
                    reset2016Credit();
        ...
        button2013.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    int sum=0;
                    OutputStreamWriter out = new OutputStreamWriter(getActivity().openFileOutput(file2013_4, 0));
                    ...
                    out.close();
                    //2013_4 이수학점 총합 저장
                    sharedPreferencesCreditSum("sum2013_4", sum);
                    sharedPreferences();
                    //다른 학번 파일 전부 0으로 reset
                    reset2017Credit();
                    reset2016Credit();
    ...
    private void showDefault2017_4() {
        int i=0;
        CheckBox chkTemp;

        //<과목순서 - 체크박스> 해시맵 생성 & 매핑
        defaultChk2017_4 = new HashMap<Integer, CheckBox>();
        defaultChk2017_4.put(1, chk2017_1);
        defaultChk2017_4.put(2, chk2017_2);
        defaultChk2017_4.put(3, chk2017_3);
        defaultChk2017_4.put(4, chk2017_4);
        defaultChk2017_4.put(5, chk2017_5);
        defaultChk2017_4.put(6, chk2017_6);
        defaultChk2017_4.put(7, chk2017_7);
        defaultChk2017_4.put(8, chk2017_8);
        defaultChk2017_4.put(9, chk2017_9);

        try {
            InputStream in = getActivity().openFileInput(file2017_4);
            if(in != null) {
                ...
                while ((str = reader.readLine()) != null) {
                    i++;
                    //i 값에 매핑된 체크박스 참조
                    chkTemp = defaultChk2017_4.get(i);
    ...
    private void showDefault2016_4() {
        int i=0;
        CheckBox chkTemp;

        //<과목순서 - 체크박스> 해시맵 생성 & 매핑
        defaultChk2016_4 = new HashMap<Integer, CheckBox>();
        defaultChk2016_4.put(1, chk2016_1);
        defaultChk2016_4.put(2, chk2016_2);
        defaultChk2016_4.put(3, chk2016_3);
        defaultChk2016_4.put(4, chk2016_4);
        defaultChk2016_4.put(5, chk2016_5);
        defaultChk2016_4.put(6, chk2016_6);
        defaultChk2016_4.put(7, chk2016_7);
        defaultChk2016_4.put(8, chk2016_8);
        defaultChk2016_4.put(9, chk2016_9);

        try {
            InputStream in = getActivity().openFileInput(file2016_4);
            if(in != null) {
                BufferedReader reader = new BufferedReader(new InputStreamReader(in));
                String str = "";
                ...
                while ((str = reader.readLine()) != null) {
                    i++;
                    //i 값에 매핑된 체크박스 참조
                    chkTemp = defaultChk2016_4.get(i);
                    if(Integer.parseInt(str) != 0) {
                        chkTemp.setChecked(true);
                        chkTemp.setText("완료");
                    } else {
    ...
    private void showDefault2015_4() {
        int i=0;
        CheckBox chkTemp;

        //<과목순서 - 체크박스> 해시맵 생성 & 매핑
        defaultChk2015_4 = new HashMap<Integer, CheckBox>();
        defaultChk2015_4.put(1, chk2015_1);
        defaultChk2015_4.put(2, chk2015_2);
        defaultChk2015_4.put(3, chk2015_3);
        defaultChk2015_4.put(4, chk2015_4);
        defaultChk2015_4.put(5, chk2015_5);
        defaultChk2015_4.put(6, chk2015_6);
        defaultChk2015_4.put(7, chk2015_7);
        defaultChk2015_4.put(8, chk2015_8);
        defaultChk2015_4.put(9, chk2015_9);

        try {
            InputStream in = getActivity().openFileInput(file2015_4);
            if(in != null) {
                BufferedReader reader = new BufferedReader(new InputStreamReader(in));
                String str = "";
                ...
                while ((str = reader.readLine()) != null) {
                    i++;
                    //i 값에 매핑된 체크박스 참조
                    chkTemp = defaultChk2015_4.get(i);
                    if(Integer.parseInt(str) != 0) {
                        chkTemp.setChecked(true);
                        chkTemp.setText("완료");
                    } else {
    ...
    private void showDefault2014_4() {
        int i=0;
        CheckBox chkTemp;

        //<과목순서 - 체크박스> 해시맵 생성 & 매핑
        defaultChk2014_4 = new HashMap<Integer, CheckBox>();
        defaultChk2014_4.put(1, chk2014_1);
        defaultChk2014_4.put(2, chk2014_2);
        defaultChk2014_4.put(3, chk2014_3);
        defaultChk2014_4.put(4, chk2014_4);
        defaultChk2014_4.put(5, chk2014_5);
        defaultChk2014_4.put(6, chk2014_6);
        defaultChk2014_4.put(7, chk2014_7);
        defaultChk2014_4.put(8, chk2014_8);
        defaultChk2014_4.put(9, chk2014_9);

        try {
            InputStream in = getActivity().openFileInput(file2014_4);
            if(in != null) {
                BufferedReader reader = new BufferedReader(new InputStreamReader(in));
                String str = "";
                ...
                while ((str = reader.readLine()) != null) {
                    i++;
                    //i 값에 매핑된 체크박스 참조
                    chkTemp = defaultChk2014_4.get(i);
                    if(Integer.parseInt(str) != 0) {
                        chkTemp.setChecked(true);
                        chkTemp.setText("완료");
                    } else {
    ...
    private void showDefault2013_4() {
        int i=0;
        CheckBox chkTemp;

        //<과목순서 - 체크박스> 해시맵 생성 & 매핑
        defaultChk2013_4 = new HashMap<Integer, CheckBox>();
        defaultChk2013_4.put(1, chk2013_1);
        defaultChk2013_4.put(2, chk2013_2);
        defaultChk2013_4.put(3, chk2013_3);
        defaultChk2013_4.put(4, chk2013_4);
        defaultChk2013_4.put(5, chk2013_5);
        defaultChk2013_4.put(6, chk2013_6);
        defaultChk2013_4.put(7, chk2013_7);
        defaultChk2013_4.put(8, chk2013_8);

        try {
            InputStream in = getActivity().openFileInput(file2013_4);
            if(in != null) {
                BufferedReader reader = new BufferedReader(new InputStreamReader(in));
                String str = "";
                ...
                while ((str = reader.readLine()) != null) {
                    i++;
                    //i 값에 매핑된 체크박스 참조
                    chkTemp = defaultChk2013_4.get(i);
                    if(Integer.parseInt(str) != 0) {
                        chkTemp.setChecked(true);
                        chkTemp.setText("완료");
                    } else {
